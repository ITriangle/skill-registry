...
- 导入、刷新或手工修改 `skills/vendor/` 中的 skill 时，必须同步更新 `locales/zh-CN/` 下对应的中文说明文档，运行 `bin/skillctl translation-stamp <skill-id>` 后通过 `bin/skillctl translation-audit`；许可证、脚本和代码文件不翻译。
