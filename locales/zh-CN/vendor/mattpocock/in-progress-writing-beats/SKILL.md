---
name: writing-beats
description: 当用户要把写作素材组织成有节奏的论述 beats，并保证关键术语先被建立时使用。 当还没有素材、需要先挖掘碎片，或用户要最终润色而非 beats 结构时不要用。
---

# 中文导读

- 使用场景：当用户要把写作素材组织成有节奏的论述 beats，并保证关键术语先被建立时使用。
- 不适用：当还没有素材、需要先挖掘碎片，或用户要最终润色而非 beats 结构时不要用。
